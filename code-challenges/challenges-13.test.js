...
//   // Solution code here...
//   return arr.filter(num=>num.includes(':)'));
...
//   // Solution code here...
//   return arr.map(i => i).filter(item=> ! item.includes('Brook'));
// };
// // const unenrollBrook = (arr) => {
// //   // Solution code here...
// //   let list =[];
...
// //       ! arr[outer][inner].includes('Brook')?list.push( arr[outer][inner]) : '' ;
// //     }
