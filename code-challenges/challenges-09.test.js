...
const returnNames = (arr) => {
  // Solution code here...
  let newArr = arr.reduce((total,curr)=> {
...
const reversedString = (arr) => {
  // Solution code here...
  return [...arr].reduce((total, curr) => curr + total);
};
...
const calculateAverage = (arr) => {
  // Solution code here...
  let arrTwo = arr.reduce((total, curr, i, arr)=> {
    return total + curr;

  });
  return arrTwo / arr.length;
};
