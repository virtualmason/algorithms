...
//   var list =[];
//   // Solution code here...
//   // compare integer to elements in sub arry
//   input.map(arr => {
...
//   });
//   // see how may times it's in arrs
//   //return the number
//   return list.length;
// };
...
//   var result = input.reduce((acc, curr) => {

//     var sum = curr.reduce((acc2, curr2) => acc2+curr2);
//     console.log(acc);
//     return acc+sum;
//   }, 0);
//   return result;
...
// function divisibleByFiveTwoToThePower(input) {
//   // Functional
...
//   }).map(str=> str.name ).map((item, i, arr)=> {
//     if(i !== arr.length -1){
//       return item + ' and ';
//     } else {
//       return item;
