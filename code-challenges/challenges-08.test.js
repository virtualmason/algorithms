...
// };
// // getBaseStatGreaterThan(snorlaxData.stats, 50) will return an array containing the 'special-defense' and 'special-attack' objects.
// /* ------------------------------------------------------------------------------------------------
// CHALLENGE 5
...
//   // Solution code here...
//  return getBaseStatGreaterThan(arr, minBaseStat).map(item=> item.stat.name);
// };
